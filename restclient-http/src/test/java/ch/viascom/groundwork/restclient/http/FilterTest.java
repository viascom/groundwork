...
import ch.viascom.groundwork.restclient.http.filter.NotFoundErrorResponseCodeFilter;
import ch.viascom.groundwork.restclient.http.filter.PathRequestFilter;
import ch.viascom.groundwork.restclient.http.model.HeaderResponse;
import ch.viascom.groundwork.restclient.http.request.simple.SimpleGetRequest;
import ch.viascom.groundwork.restclient.http.request.simple.filter.BasicAuthFilter;
import ch.viascom.groundwork.restclient.http.request.simple.filter.BearerTokenFilter;
